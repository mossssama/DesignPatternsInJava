...
//All final attributes
    ...
    @Override
    public String toString() {return "User: "+this.firstName+", "+this.lastName+", "+this.age+", "+this.phone+", "+this.address;}
    ...
    public static class UserBuilder{
        ...
        public UserBuilder(String firstName, String lastName) { this.firstName = firstName; this.lastName = lastName; }
        ...
        public User build() {   User user =  new User(this);    return user;    }
    }
}